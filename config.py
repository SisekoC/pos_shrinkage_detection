...
ANOMALY_EMPLOYEES = os.path.join(DRIVE_PATH, 'anomaly_employees.csv')
...
# Column names – matches generated datasets
COL_EMPLOYEE_ID = 'employee_id'
COL_STORE_ID = 'store_id'
COL_POS_TERMINAL_ID = 'pos_terminal_id'
COL_TRANSACTION_DATETIME = 'transaction_timestamp'
COL_SALE_AMOUNT = 'final_price'
